...
<section class="our-work">
	...
	<ul id="data" class="hidden">
		...
		<li data-id="id-1" data-type="web">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/190x120_vignette.jpg" />
			World Vision</li>
		...
		<li data-id="id-3" data-type="web">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/190x120_vignette.jpg" />
			World Vision</li>
		<li data-id="id-1" data-type="mobile">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/190x120_vignette.jpg" />
			World Vision</li>
		<li data-id="id-2" data-type="mobile">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/190x120_vignette.jpg" />
			World Vision</li>
		<li data-id="id-3" data-type="brand">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/190x120_vignette.jpg" />
			World Vision</li>
		<li data-id="id-3" data-type="media">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/190x120_vignette.jpg" />
			World Vision</li>
	</ul>
</section>
