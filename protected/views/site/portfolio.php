...
<section class="our-work">
	...
	<ul id="data" class="hidden">
		...
		<li data-id="id-2" data-type="web">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/web02.jpg" data-extended="590_01.jpg" />
			World Vision</li>
		...
		<li data-id="id-4" data-type="mobile">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/mobile01.jpg" data-extended="590_01.jpg" />
			World Vision</li>
		<li data-id="id-5" data-type="mobile">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/mobile02.jpg" data-extended="590_02.jpg" />
			World Vision</li>
		<li data-id="id-6" data-type="brand">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/brand01.jpg" data-extended="590_02.jpg" />
			World Vision</li>
		...
		<li data-id="id-12" data-type="mobile">
			<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/thumbs/mobile02.jpg" data-extended="590_01.jpg" />
			World Vision</li>
